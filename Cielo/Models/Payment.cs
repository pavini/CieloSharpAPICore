...
namespace Cielo.Core.Models
{
    public class Payment : ReturnStatus
    {
        ...
        public Payment(decimal amount, Currency currency, int installments, bool capture, string softDescriptor, CreditCard creditCard, string country = Enums.Country.BRA)
        {
        ...
        public Payment(decimal amount, Currency currency, int installments, string softDescriptor, CreditCard creditCard, RecurrentPayment recurrentPayment, string country = Enums.Country.BRA)
        {
            this.Type = PaymentType.CreditCard;
            this.Amount = amount;
            this.Currency = currency;
